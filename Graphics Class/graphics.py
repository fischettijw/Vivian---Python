...
class Ball:
    ...
    def randomColor():
        return color_rgb(rnd.randint(0, 255), rnd.randint(0, 255), rnd.randint(0, 255))
...
class Text(GraphicsObject):
    ...
    def setFace(self, face):
        if face in ["helvetica", "arial", "courier", "times roman", "comic sans ms"]:
...
def drawBullseye(myWin):
    pt = Point(250, 250)
    pt.draw(myWin)
    cir = Circle(pt, 125)
    cir.setFill(color_rgb(255, 0, 255))
    cir.draw(myWin)
    cir0 = Circle(pt, 100)
    cir0.setFill(color_rgb(0, 255, 255))
    cir0.draw(myWin)
    cir1 = Circle(pt, 75)
    cir1.setFill(color_rgb(0, 255, 0))
    cir1.draw(myWin)
    cir2 = Circle(pt, 50)
    cir2.setFill(color_rgb(255, 255, 0))
    cir2.draw(myWin)
    cir3 = Circle(pt, 25)
    cir3.setFill(color_rgb(255, 0, 0))
    cir3.draw(myWin)
